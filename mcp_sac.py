...
class SAC(RlAlgorithm):
    ...
    def optim_initialize(self, rank=0):
        ...
        self.rank = rank
        self.pi_optimizer = self.OptimCls(self.agent.model.trainable_parameters(),
    ...
    def loss(self, samples):
        ...
        if self.reparameterize:
            ...
            # print('alpha: ' + str(self._alpha) + ' log pi: ' + str(log_pi) + '  ' + str(min_log_target) + str(prior_log_pi))
        else:
