...
def simulate_policy(mocap_path, model_path):
    pass
...
def build_world(args, enable_draw):
    ...
    mocap_file_path = "./motions/humanoid3d_backflip.txt"
    env = PyBulletDeepMimicEnv(mocap_file_path=mocap_file_path, enable_draw=True)
...
if __name__ == '__main__':
    # mocap_file_path = "./motions/humanoid3d_backflip.txt"
    # simulate_policy(mocap_file_path, )
