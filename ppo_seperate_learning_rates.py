...
class PPO(PolicyGradientAlgo):
    ...
    def initialize(self, agent, *args, **kwargs):
        ...
        self.v_optimizer = self.OptimCls(agent.model.v_model.parameters(), lr=self.v_learning_rate, **self.optim_kwargs)
    ...
    def loss(self, agent_inputs, action, return_, advantage, valid, old_dist_info,
        ...
        pi_loss += entropy_loss

        perplexity = dist.mean_perplexity(dist_info, valid)
        return pi_loss, value_loss, entropy, perplexity
