...
def build_and_train(slot_affinity_code=None, log_dir='./data', run_ID=0,
    ...
    config = dict(
        sac_kwargs=dict(reward_scale=10, min_steps_learn=0, learning_rate=3e-4, batch_size=512, replay_size=1e6, discount=0.95),
        ...
        td3_kwargs=dict(),
        sampler_kwargs=dict(batch_T=32, batch_B=48, TrajInfoCls=RobotTrajInfo,
